	...
	<div class="top">
		<div class="main_wrap">
			...
			<ul class="team_logo w720 sp_display_f justify-sb f_wrap delay">
				...
				<li class="delayItem fadeIn"><img src="<?php echo get_template_directory_uri(); ?>/img/team01.svg" alt="福井ネクサスエレファンツ"></li>
				<li class="delayItem fadeIn"><img src="<?php echo get_template_directory_uri(); ?>/img/team04.svg" alt="滋賀GOブラックス"></li>
			</ul>
...
<div class="sect_topics">
	...
	<div class="section w1100">
		...
		<ul class="teams sp_display_f justify-sb f_wrap">
			<li>
				...
				<a href="https://tbirds.jp/" class="btn" target="_blank"><p>https://tbirds.jp/<img class="icon_link" src="<?php echo get_template_directory_uri(); ?>/img/icon_link.svg"></p></a>
			</li>
			<li>
				...
				<a href="http://www.m-stars.jp/" class="btn" target="_blank"><p>http://www.m-stars.jp/<img class="icon_link" src="<?php echo get_template_directory_uri(); ?>/img/icon_link.svg"></p></a>
			</li>
			<li>
				...
				<a href="https://f-ne.com/" class="btn" target="_blank"><p>https://f-ne.com/<img class="icon_link" src="<?php echo get_template_directory_uri(); ?>/img/icon_link.svg"></p></a>
			</li>
			<li>
				<figure><img src="<?php echo get_template_directory_uri(); ?>/img/team04_black.svg" alt="滋賀GOブラックス"></figure>
				<h3>滋賀GOブラックス<span>SHIGA GO BLACKS</span></h3>
				<p class="foundation">設立　平成27年12月21日</p>
				<a href="https://ocean-shiga.com/" class="btn" target="_blank"><p>https://ocean-shiga.com/<img class="icon_link" src="<?php echo get_template_directory_uri(); ?>/img/icon_link.svg"></p></a>
			</li>
		</ul>
	</div>
	...
	<div class="section padding_rl30 padding_b120">
		<div class="ttl_bg">
			<div class="ttl_wrap">
				<h2 class="ttl_en"><span>S</span><span>p</span><span>o</span><span>n</span><span>s</span><span>o</span><span>r</span><br class="sp"><span>&</span><br class="sp"><span>P</span><span>a</span><span>r</span><span>t</span><span>n</span><span>e</span><span>r</span></h2>
				<p>スポンサー＆パートナー</p>
			</div>
		</div>
		<div class="setAnime w600">
			<p class="padding_b40">日本海オセアンリーグの運営を支え、応援していただいている方々をご紹介させていただきます。</p>
			<a href="<?php echo home_url('/'); ?>sponsors/" class="btn"><p>スポンサー＆パートナー紹介<span class="arrow"></span></p></a>
		</div>
	</div>
	...
	<div class="section margin_b170 padding_rl30">
		<div class="ttl_bg">
			<div class="ttl_wrap">
				<h2 class="ttl_en"><span>R</span><span>e</span><span>c</span><span>r</span><span>u</span><span>i</span><span>t</span></h2>
				<p>採用情報</p>
			</div>
		</div>
		<div class="setAnime w600">
			<p class="padding_b40">NOLは、正職員を募集します。何事にも前向きで責任感のある、野球好き、スポーツ好きな方のご応募をお待ちしております。</p>
			<a href="<?php echo home_url('/'); ?>job/operation/" class="btn"><p>採用情報ページ<span class="arrow"></span></p></a>
		</div>
	</div>
